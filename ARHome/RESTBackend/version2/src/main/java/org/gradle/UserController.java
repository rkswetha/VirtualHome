...
public class UserController {
	...
	{
		user.setUser_id(Integer.toString((int)along.incrementAndGet()));
    ...
    @ResponseBody
    public ResponseEntity<Object> updateUsers(@NotBlank @PathVariable int id,@NotBlank@RequestParam User user ){
