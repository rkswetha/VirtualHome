...
public class UserPreferenceController
{
    ...
    @ResponseBody
    public ResponseEntity<Object> updateUserPref(@NotBlank @PathVariable int id,@NotBlank@RequestParam UserPreference userPref ){
                    userPrefDAO.updateUserPreference(userPref);
                    return new ResponseEntity<Object>(HttpStatus.NO_CONTENT);
    }
